let handler = async(m, { conn, usedPrefix, command, text:q }) => {
    ...
    switch(command){
      case 'menfesschat':
        ...
        conn.sendMessage(text, {text:txt,footer: global.footer,buttons: button,headerType: 1},{adReply: true})
        conn.menfess[id] = {
          id: id,
          a: m.sender,
          b: text,
