...
bawah = text.split('|')[1] ? text.split('|')[1] : '-'
    ...
    if (!mime) throw `balas gambar/stiker dengan perintah\n\n${usedPrefix + command} <${atas ? atas : 'teks bawah'}>|<${bawah ? bawah : 'teks atas'}>`
    ...
    let meme = `https://api.memegen.link/images/custom/${encodeURIComponent(bawah ? bawah : '-')}/${encodeURIComponent(atas ? atas : '-')}.png?background=${out}`
