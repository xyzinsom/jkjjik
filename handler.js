...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.namabot = 'Bocchi Bot'
        global.wm = 'Hitori Bocchi'
        ...
        try {
            ...
            if (`${global.settingnomorluarstatus}` == "true" && !m.sender.startsWith('62')) return m.reply(`Sorry, the bot only responds to Indonesian numbers`)
                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            await this.sendMessageModify(id, text, null, { ads: true, largeThumb: true, title: 'JiroChann', thumbnail: await getBuffer(action === 'add' ? 'https://telegra.ph/file/f88bc559017895c1dd31f.jpg' : 'https://telegra.ph/file/01001b9e5a863eefd8368.jpg') })
                        }
                    }
                }
                break
