...
global.db = new Low(new mongoDB('mongodb+srv://asroriamin:smartfren1.1@cluster0.qoocvfz.mongodb.net/?retryWrites=true&w=majority'))
...
async function connectionUpdate(update) {
  ...
  if (connection == 'open') {
      ...
      await conn.hehe("6288227248988@s.whatsapp.net", global.ftoli)
  }
