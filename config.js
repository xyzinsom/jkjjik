...
global.settingnomorluarstatus = JSON.parse(fs.readFileSync('./settings/antiluat.json'))
...
//=========== Requirements ==========//  
global.colong1 = 'JiroChann'
global.colong2 = 'By Fenrirxd'
